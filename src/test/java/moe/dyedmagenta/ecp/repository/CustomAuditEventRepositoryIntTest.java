...
import moe.dyedmagenta.ecp.config.audit.AuditEventConverter;
import moe.dyedmagenta.ecp.domain.PersistentAuditEvent;
...
import static moe.dyedmagenta.ecp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
